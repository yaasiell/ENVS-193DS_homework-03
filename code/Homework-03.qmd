...
execute: 
  ...
  warning: false # use this to make sure warning don't show up
---
...
my_data_commute_m <- my_data_commute |>
  ...
  mutate(day_of_week = str_trim(day_of_week), # removes extra spaces
         day_of_week = factor(day_of_week, # orders days in logical order
...
![](images/personal_data_sketch.jpg){width="70%"}

## c. Make a draft of your visualization.

![](images/affective_visualization_draft.jpg){width="70%"}
...
[View Affective Visualization Slides](https://docs.google.com/presentation/d/1ptADADHHrWwlQuSt5NLrboyH8CqZQBV_VV5w35pvUbk/edit?usp=sharing)
...
![](images/statistical_critique_data.png){width="70%"}
